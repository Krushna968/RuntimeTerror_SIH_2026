...
class OceanAnalyticsAgent:
    def __init__(self, marine_agent: Optional[MarineDataAgent] = None):
    ...
    def generate_pfz_hotspots(self, reference_port_key: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        for pfz in base_pfz_locations:
            ...
            # Fetch satellite data at PFZ center
            obs = self.marine_agent.get_point_observation(lat, lon)
            sst = obs["sea_surface_temperature_c"]
            chl = obs["chlorophyll_a_mg_m3"]
