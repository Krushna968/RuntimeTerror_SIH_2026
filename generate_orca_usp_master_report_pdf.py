...
def build_usp_pdf(filename="ORCA_Project_USP_Comprehensive_Document.pdf"):
    ...
    meta_table_data = [
        ...
        [
            ...
            Paragraph("8 Indic Languages (Hindi, Tamil, Telugu, Malayalam, etc.)", table_cell_style),
    ...
    fail_data = [
        ...
        [
            ...
            Paragraph("<b>8 Indic regional languages</b> with multi-turn voice dialogue (Web Speech STT/TTS).", table_cell_style)
        ]
    ]
    ...
    agent_spec_data = [
        ...
        [
            ...
            Paragraph("8 Indic regional languages, coastal maritime dialect token mapping.", table_cell_style)
        ],
        [
    ...
    # =========================================================================
    # PAGE 4: USP 5, USP 6 & USP 7 (NAVIGATION, 8 LANGUAGES, AUDITING)
    # =========================================================================
    ...
    comp_data = [
        ...
        [
            ...
            Paragraph("<b>8 Indic Languages with Dialect STT / TTS.</b>", table_cell_bold)
        ],
        [
