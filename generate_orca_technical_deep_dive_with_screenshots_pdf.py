...
class TechnicalNumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        self.setFont("Helvetica", 8)
        self.setFillColor(COLOR_MUTED_TEXT)
        self.drawString(225, 32, "• Team Runtime Terror • Production Cloud Specification")
...
def build_technical_pdf(filename="ORCA_Technical_Architecture_And_Deployment_Report.pdf"):
    ...
    tech_matrix_data = [
        ...
        [
            ...
            Paragraph("SpeechRecognition (STT) voice input and SpeechSynthesis (TTS) read-aloud in 8 Indic locales.", td_style)
        ]
    ]
    ...
    file_arch_data = [
        ...
        [
            ...
            Paragraph("<b>MultilingualAgent:</b> Script detection for 8 Indian languages, vernacular deterministic template synthesis, phonetic dictionaries.", td_style)
        ],
        [
