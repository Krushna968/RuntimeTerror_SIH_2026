...
class NumberedCanvas(canvas.Canvas):
    ...
    def draw_page_decorations(self, page_count):
        ...
        self.drawString(54, 32, "TEAM RUNTIME TERROR")
        self.setFont("Helvetica", 8)
        self.setFillColor(COLOR_MUTED_TEXT)
...
def build_pdf(filename="ORCA_Project_Comprehensive_Technical_Report.pdf"):
    ...
    meta_data = [
        ...
        [Paragraph("<b>Development Team</b>", table_cell_bold), Paragraph("<b>Team Runtime Terror</b> (SIH 2026 Grand Finale)", table_cell_style)],
    ...
    story.append(Paragraph("• <b>Language &amp; Literacy Barriers:</b> Traditional advisory bulletins are published as complex, English-heavy PDFs. ORCA delivers voice-driven, colloquial dialogues in <b>8 Indian regional languages</b>.", bullet_style))
...
• Estimated Fuel Burn: Fuel_L = ETA · 14.5 Litres/Hour (Typical 36-45ft Indian Mechanized Trawler)"""
    ...
    story.append(Paragraph(
        "ORCA breaks language barriers by providing native conversational intelligence in <b>8 Indian languages</b>: English, Hindi, Tamil, Telugu, Malayalam, Bengali, Gujarati, and Marathi.",
        body_style
    ))
    ...
    story.append(Paragraph(
        "Team Runtime Terror engineered ORCA through a rigorous 6-phase agile lifecycle:",
        body_style
    ))
